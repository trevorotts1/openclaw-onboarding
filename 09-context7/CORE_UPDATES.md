...
# Context7 Setup - Core File Updates
...
```
## Context7 Rule [PRIORITY: HIGH]
- Before using ANY library or framework, check Context7 for current docs
- Training data may be outdated - Context7 gives real-time documentation
- Full guide: [MASTER_FILES_FOLDER]/OpenClaw Onboarding/09-context7/context7-full.md
```
...
- Use Context7 to look up current docs for any library/framework
- Always prefer Context7 over training knowledge for API syntax
- Full guide: [MASTER_FILES_FOLDER]/OpenClaw Onboarding/09-context7/context7-full.md
```
...
```
## Context7 Setup - Installed [DATE]
- Real-time documentation lookup tool
- Full guide: [MASTER_FILES_FOLDER]/OpenClaw Onboarding/09-context7/context7-full.md
```
