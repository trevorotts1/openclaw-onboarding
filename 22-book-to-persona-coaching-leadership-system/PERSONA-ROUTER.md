...
2. Run: `python3 ~/.openclaw/scripts/gemini-search.py "<task keywords>"`
...
python3 ~/.openclaw/scripts/gemini-search.py "closing a sale making an offer pricing"

# Find best persona for a content task
python3 ~/.openclaw/scripts/gemini-search.py "content marketing brand story messaging"

# Find best persona for a productivity task
python3 ~/.openclaw/scripts/gemini-search.py "habits systems daily routine productivity"

# Find best persona for a leadership task
python3 ~/.openclaw/scripts/gemini-search.py "team leadership purpose why vision"
```
