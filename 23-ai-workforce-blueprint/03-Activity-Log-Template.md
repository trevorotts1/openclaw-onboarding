...
- Every morning: run `python3 ~/.openclaw/scripts/gemini-indexer.py` + `# Handled by gemini-indexer.py` on yesterday's completed log
...
3. Run `python3 ~/.openclaw/scripts/gemini-indexer.py` + `# Handled by gemini-indexer.py` on the archive
