...
- Every morning: run `python3 ~/clawd/scripts/gemini-indexer.py` + `qmd embed` on yesterday's completed log
...
3. Run `python3 ~/clawd/scripts/gemini-indexer.py` + `qmd embed` on the archive
