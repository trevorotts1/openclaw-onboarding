...
| R-PERSONA-GROUNDING | 8.43 | FAIL | working/funnels/focusforge/persona-selection-log.md | persona_named_surfaces=6/3 surfaces(5.0/5.0); selector_grounding_strength=ran (DEGRADED: only task_fit live ~0.8; layers 1-4 neutral-0.6 floor -> layer-quality mean 0.64)(3.2/5.0); task_mode_applied=8 Task-Mode/Section-4 governance marker(s)(1.5/1.5) |
