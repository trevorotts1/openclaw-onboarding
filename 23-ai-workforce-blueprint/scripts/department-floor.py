...
THE FIX (this module): compute the EXPECTED floor =
    ...
    (marketing, sales, billing-finance, customer-support, web-development,
     app-development, graphics, video, audio, research, communications, crm,
     openclaw-maintenance, legal, social-media, paid-advertisement,
     personal-assistant, general-task, project-architecture-office,
     bugs, healer)
...
# NOTE: the HARDCODED_MANDATORY list above already reflects 28 (21 items).
# The comments throughout this file that say "16 mandatory" or "19 mandatory"
# or "26 floor" are stale from earlier versions — the naming-map is the
# authoritative count. list-canonical-departments.py --json prints the live count.
HARDCODED_MANDATORY = [
...
def matched_vertical_pack_departments(nm, core_answers):
    ...
    Return the list of vertical-pack department ids for the client — includes:
      ...
      2. Additional pack departments that match the client's industry keywords
         (flavor/extras on top of the 28 floor, not gating).
