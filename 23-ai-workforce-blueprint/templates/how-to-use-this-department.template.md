# How to Use the {{DEPARTMENT_NAME}} Department {{DEPARTMENT_EMOJI}}

**Department:** {{DEPARTMENT_NAME}}
**Department head:** {{DEPARTMENT_HEAD}}
**Folder:** `departments/{{DEPARTMENT_SLUG}}/`
**Generated for:** {{COMPANY_NAME}}
**Last updated:** {{GENERATION_DATE}}

> This is the plain-language guide to the {{DEPARTMENT_NAME}} department. Most
> people never realize this department exists or know how to put it to work.
> This document fixes that. When you ask "how do I use the {{DEPARTMENT_NAME}}
> department?" or "how do I use the {{SPECIALIST_EXAMPLE}}?", this is the
...
{{DEPARTMENT_PLAIN_LANGUAGE_PURPOSE}}

In one sentence: **{{DEPARTMENT_ONE_LINER}}**

You do not need to know which specialist does what. You just tell the department
what you want in plain English, and the department head ({{DEPARTMENT_HEAD}})
...
{{DEPARTMENT_WHEN_TO_USE_BULLETS}}
...
1. **Just say it in plain English.** Message your agent like you would a
   teammate: "I need help with {{PLAIN_REQUEST_EXAMPLE}}." That is enough to start.
2. **Name the department if you want to be specific.** "Have the
   {{DEPARTMENT_NAME}} department handle {{PLAIN_REQUEST_EXAMPLE}}." This routes
   it straight to {{DEPARTMENT_HEAD}}.
3. **Name a specialist if you know exactly who you want.** See the specialist
   list in Section 4 and ask for them by role: "Get the {{SPECIALIST_EXAMPLE}}
   to {{SPECIALIST_REQUEST_EXAMPLE}}."
...
1. **Acknowledgment.** {{DEPARTMENT_HEAD}} confirms the request landed and, if
...
4. **Delivery.** You get the finished result: {{DEPARTMENT_TYPICAL_DELIVERABLES}}.
...
- "How do I use the {{DEPARTMENT_NAME}} department?"
- "What can the {{DEPARTMENT_NAME}} department do for me?"
- "How do I use the {{SPECIALIST_EXAMPLE}}?"
- "Who handles {{PLAIN_REQUEST_EXAMPLE}}?"
- "What do I get back if I ask {{DEPARTMENT_NAME}} for {{PLAIN_REQUEST_EXAMPLE}}?"
