# How to Use the Account Management Department 💼

**Department:** Account Management
**Department head:** Director of Account Management
**Folder:** `departments/account-management/`
**Generated for:** {{COMPANY_NAME}}
**Last updated:** {{GENERATION_DATE}}

> This is the plain-language guide to the Account Management department. Most
> people never realize this department exists or know how to put it to work.
> This document fixes that. When you ask "how do I use the Account Management
> department?" or "how do I use the Client Relationship Manager?", this is the
...
The Account Management department owns all account management work for your business.

In one sentence: **Client relationships, deliverables, retention**

You do not need to know which specialist does what. You just tell the department
what you want in plain English, and the department head (Director of Account Management)
...
- Primary relationship steward for a defined portfolio of healthy.
- Your singular mandate is to prevent preventable churn.
...
1. **Just say it in plain English.** Message your agent like you would a
   teammate: "I need help with something from the account management team." That is enough to start.
2. **Name the department if you want to be specific.** "Have the
   Account Management department handle something from the account management team." This routes
   it straight to Director of Account Management.
3. **Name a specialist if you know exactly who you want.** See the specialist
   list in Section 4 and ask for them by role: "Get the Client Relationship Manager
   to take on a account management task for you."
...
| --- | --- |
| **Client Relationship Manager** | Primary relationship steward for a defined portfolio of healthy. |
| **Retention Specialist** | Your singular mandate is to prevent preventable churn. |

### What each specialist is for, with an example request

**Client Relationship Manager**

- *What it is for:* Primary relationship steward for a defined portfolio of healthy.
- *Example request:* "Have the Client Relationship Manager take this on: Primary relationship steward for a defined portfolio of healthy."

**Retention Specialist**

- *What it is for:* Your singular mandate is to prevent preventable churn.
- *Example request:* "Have the Retention Specialist take this on: Your singular mandate is to prevent preventable churn."
...
1. **Acknowledgment.** Director of Account Management confirms the request landed and, if
...
4. **Delivery.** You get the finished result: the finished account management work you asked for.
...
- "How do I use the Account Management department?"
- "What can the Account Management department do for me?"
- "How do I use the Client Relationship Manager?"
- "Who handles something from the account management team?"
- "What do I get back if I ask Account Management for something from the account management team?"
