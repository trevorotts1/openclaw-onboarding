...
- Primary relationship steward for a defined portfolio of healthy, active accounts - the Green-status clients.
...
| --- | --- |
| **Client Relationship Manager** | Primary relationship steward for a defined portfolio of healthy, active accounts - the Green-status clients who. |
...
- *What it is for:* Primary relationship steward for a defined portfolio of healthy, active accounts - the Green-status clients who.
- *Example request:* "Have the Client Relationship Manager take this on: Primary relationship steward for a defined portfolio of healthy, active accounts - the."
