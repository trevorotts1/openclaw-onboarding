...
- You own the infrastructure layer that everything else runs on  -  cloud provisioning, networking, CI/CD.
...
| --- | --- |
| **QA Engineer** | Systematic guardian of software quality  -  the engineer who builds and executes the testing frameworks, automation. |
...
- *What it is for:* Systematic guardian of software quality  -  the engineer who builds and executes the testing frameworks, automation.
- *Example request:* "Have the QA Engineer take this on: Systematic guardian of software quality  -  the engineer who builds and executes the."
