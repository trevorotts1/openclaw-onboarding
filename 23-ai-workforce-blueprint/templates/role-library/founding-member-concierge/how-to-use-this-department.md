# How to Use the Founding Member Concierge Department 

**Department:** Founding Member Concierge
**Department head:** Director of Founding Member Concierge
**Folder:** `departments/founding-member-concierge/`
**Generated for:** {{COMPANY_NAME}}
**Last updated:** {{GENERATION_DATE}}

> This is the plain-language guide to the Founding Member Concierge department. Most
> people never realize this department exists or know how to put it to work.
> This document fixes that. When you ask "how do I use the Founding Member Concierge
> department?" or "how do I use the Concierge Lead?", this is the
...
The Founding Member Concierge department owns all founding member concierge work for your business.

In one sentence: **Work owned by the Founding Member Concierge department**

You do not need to know which specialist does what. You just tell the department
what you want in plain English, and the department head (Director of Founding Member Concierge)
...
- Primary relationship ambassador  -  the named, trusted face that founding members associate with their entire.
- Operational backbone of the founding member program  -  the person responsible for ensuring.
...
1. **Just say it in plain English.** Message your agent like you would a
   teammate: "I need help with something from the founding member concierge team." That is enough to start.
2. **Name the department if you want to be specific.** "Have the
   Founding Member Concierge department handle something from the founding member concierge team." This routes
   it straight to Director of Founding Member Concierge.
3. **Name a specialist if you know exactly who you want.** See the specialist
   list in Section 4 and ask for them by role: "Get the Concierge Lead
   to take on a founding member concierge task for you."
...
| --- | --- |
| **Concierge Lead** | Primary relationship ambassador  -  the named, trusted face that founding members associate with their entire lived. |
| **Membership Specialist** | Operational backbone of the founding member program  -  the person responsible for ensuring that every benefit promised. |

### What each specialist is for, with an example request

**Concierge Lead**

- *What it is for:* Primary relationship ambassador  -  the named, trusted face that founding members associate with their entire lived.
- *Example request:* "Have the Concierge Lead take this on: Primary relationship ambassador  -  the named, trusted face that founding members."

**Membership Specialist**

- *What it is for:* Operational backbone of the founding member program  -  the person responsible for ensuring that every benefit promised.
- *Example request:* "Have the Membership Specialist take this on: Operational backbone of the founding member program  -  the person responsible."
...
1. **Acknowledgment.** Director of Founding Member Concierge confirms the request landed and, if
...
4. **Delivery.** You get the finished result: the finished founding member concierge work you asked for.
...
- "How do I use the Founding Member Concierge department?"
- "What can the Founding Member Concierge department do for me?"
- "How do I use the Concierge Lead?"
- "Who handles something from the founding member concierge team?"
- "What do I get back if I ask Founding Member Concierge for something from the founding member concierge team?"
