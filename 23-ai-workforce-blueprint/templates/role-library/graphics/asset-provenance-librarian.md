...
1. Pre-validation per endpoint limits (from MODEL-SPECS §1):
   - GPT-Image-2.5 (I2I) and Nano Banana 2: max 30MB, formats jpeg/png/webp/jpg.
...
1. **On production promotion (banking):**
   a. From the winning test receipt, extract: model, full assembled prompt, all params, seed (if the endpoint provides one — Ideogram V3 and Wan 2.7 return a seed; GPT-Image-2.5, Nano Banana 2, Seedream do not).
