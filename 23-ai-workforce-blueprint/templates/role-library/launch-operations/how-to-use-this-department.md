# How to Use the Launch Operations Department 

**Department:** Launch Operations
**Department head:** Director of Launch Operations
**Folder:** `departments/launch-operations/`
**Generated for:** {{COMPANY_NAME}}
**Last updated:** {{GENERATION_DATE}}

> This is the plain-language guide to the Launch Operations department. Most
> people never realize this department exists or know how to put it to work.
> This document fixes that. When you ask "how do I use the Launch Operations
> department?" or "how do I use the Go To Market Specialist?", this is the
...
The Launch Operations department owns all launch operations work for your business.

In one sentence: **Work owned by the Launch Operations department**

You do not need to know which specialist does what. You just tell the department
what you want in plain English, and the department head (Director of Launch Operations)
...
- Operational engine that keeps every active launch on track  -  tracking every milestone, chasing every owner.
...
1. **Just say it in plain English.** Message your agent like you would a
   teammate: "I need help with something from the launch operations team." That is enough to start.
2. **Name the department if you want to be specific.** "Have the
   Launch Operations department handle something from the launch operations team." This routes
   it straight to Director of Launch Operations.
3. **Name a specialist if you know exactly who you want.** See the specialist
   list in Section 4 and ask for them by role: "Get the Go To Market Specialist
   to take on a launch operations task for you."
...
| --- | --- |
| **Go To Market Specialist** | Owns the Go To Market Specialist work. |
| **Launch Manager** | Operational engine that keeps every active launch on track  -  tracking every milestone, chasing every owner. |

### What each specialist is for, with an example request

**Go To Market Specialist**

- *What it is for:* Owns the Go To Market Specialist work.
- *Example request:* "Have the Go To Market Specialist take on a task in its area."

**Launch Manager**

- *What it is for:* Operational engine that keeps every active launch on track  -  tracking every milestone, chasing every owner.
- *Example request:* "Have the Launch Manager take this on: Operational engine that keeps every active launch on track  -  tracking every milestone."
...
1. **Acknowledgment.** Director of Launch Operations confirms the request landed and, if
...
4. **Delivery.** You get the finished result: the finished launch operations work you asked for.
...
- "How do I use the Launch Operations department?"
- "What can the Launch Operations department do for me?"
- "How do I use the Go To Market Specialist?"
- "Who handles something from the launch operations team?"
- "What do I get back if I ask Launch Operations for something from the launch operations team?"
