# How to Use the Listings Management Department 🏘️

**Department:** Listings Management
**Department head:** Director of Listings Management
**Folder:** `departments/listings/`
**Generated for:** {{COMPANY_NAME}}
**Last updated:** {{GENERATION_DATE}}

> This is the plain-language guide to the Listings Management department. Most
> people never realize this department exists or know how to put it to work.
> This document fixes that. When you ask "how do I use the Listings Management
> department?" or "how do I use the Listing Creator?", this is the
...
In one sentence: **MLS, photos, descriptions, syndication**

You do not need to know which specialist does what. You just tell the department
what you want in plain English, and the department head (Director of Listings Management)
...
- Your mandate is singular and non-negotiable.
- Distribution and platform-operations engine of the Listings department.
...
1. **Just say it in plain English.** Message your agent like you would a
   teammate: "I need help with something from the listings management team." That is enough to start.
2. **Name the department if you want to be specific.** "Have the
   Listings Management department handle something from the listings management team." This routes
   it straight to Director of Listings Management.
3. **Name a specialist if you know exactly who you want.** See the specialist
   list in Section 4 and ask for them by role: "Get the Listing Creator
   to take on a listings management task for you."
...
| --- | --- |
| **Listing Creator** | Your mandate is singular and non-negotiable. |
| **Marketplace Specialist** | Distribution and platform-operations engine of the Listings department. |

### What each specialist is for, with an example request

**Listing Creator**

- *What it is for:* Your mandate is singular and non-negotiable.
- *Example request:* "Have the Listing Creator take this on: Your mandate is singular and non-negotiable."

**Marketplace Specialist**

- *What it is for:* Distribution and platform-operations engine of the Listings department.
- *Example request:* "Have the Marketplace Specialist take this on: Distribution and platform-operations engine of the Listings department."
...
1. **Acknowledgment.** Director of Listings Management confirms the request landed and, if
...
4. **Delivery.** You get the finished result: the finished listings management work you asked for.
...
- "How do I use the Listings Management department?"
- "What can the Listings Management department do for me?"
- "How do I use the Listing Creator?"
- "Who handles something from the listings management team?"
- "What do I get back if I ask Listings Management for something from the listings management team?"
