...
| **62** | Declared and machine-enforced phase count | **Changed by Wave C: 36 -> 40** (manifest_version 50 -> 51), then by later waves to **62** (manifest_version 69; count is read from `len(manifest.phases)`, never hardcoded) |
...
manifest_version 69, declared count 62.
