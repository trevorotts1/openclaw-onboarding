...
| Phases with no legacy short code | `P-STYLE-SPEC` (4.84), `P8.3-INFOGRAPHIC` (8.3), `P-BUNDLE-GATE` (9.95) | added after the numeric short-code era; the manifest row is the only key |
