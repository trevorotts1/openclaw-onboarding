...
| **Slide Submitter** | Submits all prompts to Kie.ai GPT Image 2 (owns_phase null at manifest v67; unreconciled). |
...
- *What it is for:* Submits all prompts to Kie.ai GPT Image 2 (owns_phase null at manifest v67; unreconciled).
- *Example request:* "Have the Slide Submitter take this on: Submits all prompts to Kie.ai GPT Image 2 (owns_phase null at manifest v67; unreconciled)."
