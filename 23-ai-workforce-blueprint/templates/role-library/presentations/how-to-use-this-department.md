...
- Audio Demonstration + Fish Audio Expression Specialist for the company, the Voice Director Vivienne Locke.
- Brand Steward for the company, the specialist responsible for creating and maintaining the STYLE BLOCK.
- Capacity and Reliability Engineer for the company, the specialist responsible for ensuring every deck run.
- Front door for one specific request.
- Delivery Concierge for the company, ROLE-13 in the Presentations department.
- First-Time-User Onboarding specialist for the Presentations department at the company.
...
| --- | --- |
| **Audio Demonstration Specialist** | Audio Demonstration + Fish Audio Expression Specialist for the company, the Voice Director Vivienne Locke. |
| **Brand Steward** | Brand Steward for the company, the specialist responsible for creating and maintaining the STYLE BLOCK that governs. |
...
| **Content To Presentation Architect** | Front door for one specific request. |
| **Delivery Concierge** | Delivery Concierge for the company, ROLE-13 in the Presentations department. |
| **First Time Onboarding Presentations** | First-Time-User Onboarding specialist for the Presentations department at the company, the Onboarding Host Nadia Wells. |
| **Hook Strategist** | Hook Strategist for the company, the specialist who owns the Hook Lab end to end. |
...
| **Pptx Assembly Specialist** | PPTX Assembly Specialist for the company, the specialist responsible for Phase 6 of the CLIENT WEBINAR DECK SOP. |
| **Presenter Coach** | Presenter Coach  -  Talk-Track Specialist for the company, the specialist who bridges the gap between a finished. |
| **Presenters Guide Specialist** | Presenters Guide Specialist for the company, the Stage Producer Delia Crewe. |
| **Presenters Speech Writer** | Presenters Speech Writer for the company, the Speechwright Roland Pace. |
| **Slide Copywriter** | Slide Copywriter for the company, the specialist responsible for writing every word on every slide of every branded. |
| **Slide Image Creator** | Slide Image Creator for the company, the specialist responsible for writing one image prompt per slide. |
| **Slide Submitter** | Slide Submitter for the company, the specialist responsible for Phase 4 of the CLIENT WEBINAR DECK SOP (master. |
| **Typography Architect** | Typography Architect for the company, the Type Director Marcus Vane. |

### What each specialist is for, with an example request

**Audio Demonstration Specialist**

- *What it is for:* Audio Demonstration + Fish Audio Expression Specialist for the company, the Voice Director Vivienne Locke.
- *Example request:* "Have the Audio Demonstration Specialist take this on: Audio Demonstration + Fish Audio Expression Specialist for the company."

**Brand Steward**

- *What it is for:* Brand Steward for the company, the specialist responsible for creating and maintaining the STYLE BLOCK that governs.
- *Example request:* "Have the Brand Steward take this on: Brand Steward for the company, the specialist responsible for creating and maintaining."
...
- *What it is for:* Front door for one specific request.
- *Example request:* "Have the Content To Presentation Architect take this on: Front door for one specific request."

**Delivery Concierge**

- *What it is for:* Delivery Concierge for the company, ROLE-13 in the Presentations department.
- *Example request:* "Have the Delivery Concierge take this on: Delivery Concierge for the company, ROLE-13 in the Presentations department."

**First Time Onboarding Presentations**

- *What it is for:* First-Time-User Onboarding specialist for the Presentations department at the company, the Onboarding Host Nadia Wells.
...
- *What it is for:* Hook Strategist for the company, the specialist who owns the Hook Lab end to end.
- *Example request:* "Have the Hook Strategist take this on: Hook Strategist for the company, the specialist who owns the Hook Lab end to end."
...
- *What it is for:* PPTX Assembly Specialist for the company, the specialist responsible for Phase 6 of the CLIENT WEBINAR DECK SOP.
- *Example request:* "Have the Pptx Assembly Specialist take this on: PPTX Assembly Specialist for the company, the specialist responsible for Phase 6."

**Presenter Coach**

- *What it is for:* Presenter Coach  -  Talk-Track Specialist for the company, the specialist who bridges the gap between a finished.
- *Example request:* "Have the Presenter Coach take this on: Presenter Coach  -  Talk-Track Specialist for the company."

**Presenters Guide Specialist**

- *What it is for:* Presenters Guide Specialist for the company, the Stage Producer Delia Crewe.
- *Example request:* "Have the Presenters Guide Specialist take this on: Presenters Guide Specialist for the company, the Stage Producer Delia Crewe."

**Presenters Speech Writer**

- *What it is for:* Presenters Speech Writer for the company, the Speechwright Roland Pace.
- *Example request:* "Have the Presenters Speech Writer take this on: Presenters Speech Writer for the company, the Speechwright Roland Pace."

**Slide Copywriter**

- *What it is for:* Slide Copywriter for the company, the specialist responsible for writing every word on every slide of every branded.
- *Example request:* "Have the Slide Copywriter take this on: Slide Copywriter for the company, the specialist responsible for writing every word."

**Slide Image Creator**

- *What it is for:* Slide Image Creator for the company, the specialist responsible for writing one image prompt per slide.
- *Example request:* "Have the Slide Image Creator take this on: Slide Image Creator for the company, the specialist responsible for writing one image."

**Slide Submitter**

- *What it is for:* Slide Submitter for the company, the specialist responsible for Phase 4 of the CLIENT WEBINAR DECK SOP (master.
- *Example request:* "Have the Slide Submitter take this on: Slide Submitter for the company, the specialist responsible for Phase 4 of the CLIENT."

**Typography Architect**

- *What it is for:* Typography Architect for the company, the Type Director Marcus Vane.
- *Example request:* "Have the Typography Architect take this on: Typography Architect for the company, the Type Director Marcus Vane."
