...
| **Prompt Author** | You write each slide's rich image prompt to the 9,000-to-14,000-character density standard (hard floor 5,000. |
...
- *What it is for:* You write each slide's rich image prompt to the 9,000-to-14,000-character density standard (hard floor 5,000.
