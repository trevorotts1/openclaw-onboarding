...
test("PRES-024 [interview-app D1]: legacy contract intact — reuse, completeness gate, intake fetch", async () => {
  ...
  const again = await h.handle("POST", "/api/sessions", { token: "admin-tok", body: { company_id: "acme", installation_id: "install-test", presentation_id: "presentation-test", run_id: "run-ia-legacy", box_id: "box1", questions_payload: PAYLOAD } });
