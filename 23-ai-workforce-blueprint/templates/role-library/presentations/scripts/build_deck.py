...
def _import_slide_craft():
    """Import the slide_craft module that ships beside build_deck.py.
    Tries a normal import first, then a path-based load from this file's own directory.
    Returns the module or None. Mirrors _import_intelligence_engines_check (:5338-5358)
    and _import_pitch_engines_check (:5445-5461)."""
    try:
        import importlib
...
# ---- U051: SLIDE-CRAFT wrappers and shared warn-mode helper -----------------
