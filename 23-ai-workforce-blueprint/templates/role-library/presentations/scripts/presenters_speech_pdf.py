...
OUTPUT FILENAME
---------------
The canonical shipped name is PRESENTERS-SPEECH.pdf (plural possessive; SOP 9.2, matching
the AF-DH1 client-package whitelist + the producer presenters-speech-writer role +
PRESENTER-GUIDE/PRESENTER-AUDIO).
...
# AF-BUNDLE-COMPLETE floor. PRESENTERS-SPEECH.pdf is a REQUIRED deliverable; a
