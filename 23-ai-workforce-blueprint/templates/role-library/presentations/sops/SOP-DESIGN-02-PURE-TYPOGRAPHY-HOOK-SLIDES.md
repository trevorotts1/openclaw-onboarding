...
| Trigger | Verdict |
|---------|---------|
| A PURE_TYPE_HOOK slide was rendered locally (Pillow/PIL `Image.new`/ImageDraw, PowerPoint card, native image tool, or any non-kie.ai model) instead of by kie.ai gpt-image-2.5 | AUTO-FAIL that slide (`AF-LOCAL-CANVAS` / `AF-CANONICAL-RENDER-BYPASS`) |
