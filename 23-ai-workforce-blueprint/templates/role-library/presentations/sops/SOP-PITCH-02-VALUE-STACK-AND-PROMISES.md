...
| 5 re-stack at every drop | AF-C7 sub-condition (c) ADDS value; FIX-5b promise slide between drops | each drop adds value; a promise is restated between drops | a drop that strips value or restates no promise |
