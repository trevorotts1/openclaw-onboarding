...
**What failed:** 100% of 98 image prompts (across all four decks) were below the 1500-char floor (the floor in force at the time of this incident; the floor has since been raised to the reconciled 5,000-char standard -- see Detection). Median was 277 chars -- 5.4x under that floor. Zero prompts had proper archetype declarations or negative blocks.
