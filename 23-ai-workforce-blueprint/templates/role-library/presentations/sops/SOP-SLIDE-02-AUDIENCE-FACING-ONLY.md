...
**Master authority:** universal-sops/CLIENT-WEBINAR-DECK-SOP.md (SOP-PITCH-* cluster + SOP-PROCLAMATION-01 (Kill List operational home: devils-advocate-presentations SOP 9.1) (PRESENTATION-MASTER-DOCTRINE.md §4) rule 15 "the slide is not the script", SOP-PITCH-* cluster + SOP-PROCLAMATION-01 (Kill List operational home: devils-advocate-presentations SOP 9.1) (PRESENTATION-MASTER-DOCTRINE.md §4) itself as internal build doctrine)
...
**Status:** Reference SOP, RECONCILED with the live gate. The audience-facing battery is ALREADY WIRED in qc-specialist-presentations.md as auto-fail AF-C9 (presenter narration, AI meta-commentary, image/scene descriptions, telegraphing/stage-direction kickers, and the literal word "webinar"), re-verified at the composed slide by AF-F9 (OCR readback). The one genuinely net-new check this overhaul adds is the blanket bracket-token-on-render ban: AF-AUD-6 / AF-PLACEHOLDER below is now wired as AF-F10 (FIX-12) in the QC Image/Final auto-fail table (any `[...]` token or "owner to confirm"/"insert"/"tbd"/"client win" string rendered on the face blocks FINAL). The draft codes AF-AUD-1..5 map to AF-C9; AF-AUD-6 maps to AF-F10. Do NOT add a parallel AF-AUD namespace; this document is the authored doctrine behind the live checks.
...
| AUD-2: Internal pitch-doctrine caption | The line restates a SOP-PITCH-* + SOP-PROCLAMATION-01 (Pitch Doctrine points 1-18 reproduced in devils-advocate-presentations SOP 9.1) (PRESENTATION-MASTER-DOCTRINE.md §4) doctrine principle as a caption (value-vs-price mechanics, "the lower the price the greater the value", "in the next breath the real number"). | "AF-AUD (AUD-2): slide N prints internal build doctrine as a caption: '[line]'. The Pitch Doctrine is build-logic, never slide copy. Delete from the slide." |
