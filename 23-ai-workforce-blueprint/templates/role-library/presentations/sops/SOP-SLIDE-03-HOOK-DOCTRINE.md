...
- **qc-specialist-presentations copy-QC criterion 11 (HOOK COUNT) (PRESENTATION-MASTER-DOCTRINE.md §4):** replace "Fewer than 7 = auto-fail" with "More than 4 hook-carrying slides = auto-fail; zero dedicated hook slides = auto-fail; the hook footer-stamped on any slide = auto-fail."
