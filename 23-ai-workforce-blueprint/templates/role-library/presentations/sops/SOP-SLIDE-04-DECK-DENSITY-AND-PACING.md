...
2. **The value anchor lands near the one-third mark**, not the back third. Target 25 to 45% depth — the same band DEN-2 enforces as 0.25-0.45. (gold-standard: s24 = 32%.) The anchor is a value-plant ("remember this number"), not a drop.
