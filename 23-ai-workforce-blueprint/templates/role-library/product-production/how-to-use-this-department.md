# How to Use the Product Production Department 

**Department:** Product Production
**Department head:** Director of Product Production
**Folder:** `departments/product-production/`
**Generated for:** {{COMPANY_NAME}}
**Last updated:** {{GENERATION_DATE}}

> This is the plain-language guide to the Product Production department. Most
> people never realize this department exists or know how to put it to work.
> This document fixes that. When you ask "how do I use the Product Production
> department?" or "how do I use the Product Manager?", this is the
...
The Product Production department owns all product production work for your business.

In one sentence: **Work owned by the Product Production department**

You do not need to know which specialist does what. You just tell the department
what you want in plain English, and the department head (Director of Product Production)
...
- You live at the intersection of the owner's business vision, the customer's needs, and the production team's.
- Operational engine of the production department - the person who makes sure that every production job runs.
...
1. **Just say it in plain English.** Message your agent like you would a
   teammate: "I need help with something from the product production team." That is enough to start.
2. **Name the department if you want to be specific.** "Have the
   Product Production department handle something from the product production team." This routes
   it straight to Director of Product Production.
3. **Name a specialist if you know exactly who you want.** See the specialist
   list in Section 4 and ask for them by role: "Get the Product Manager
   to take on a product production task for you."
...
| --- | --- |
| **Product Manager** | You live at the intersection of the owner's business vision, the customer's needs, and the production team's. |
| **Production Coordinator** | Operational engine of the production department - the person who makes sure that every production job runs on. |

### What each specialist is for, with an example request

**Product Manager**

- *What it is for:* You live at the intersection of the owner's business vision, the customer's needs, and the production team's.
- *Example request:* "Have the Product Manager take this on: You live at the intersection of the owner's business vision, the customer's needs, and."

**Production Coordinator**

- *What it is for:* Operational engine of the production department - the person who makes sure that every production job runs on.
- *Example request:* "Have the Production Coordinator take this on: Operational engine of the production department - the person who makes sure that every."
...
1. **Acknowledgment.** Director of Product Production confirms the request landed and, if
...
4. **Delivery.** You get the finished result: the finished product production work you asked for.
...
- "How do I use the Product Production department?"
- "What can the Product Production department do for me?"
- "How do I use the Product Manager?"
- "Who handles something from the product production team?"
- "What do I get back if I ask Product Production for something from the product production team?"
