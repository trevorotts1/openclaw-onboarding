...
- Research Agent for the company's Project Architecture Office - the deep-research function that gathers the.
...
| **Research Agent** | Research Agent for the company's Project Architecture Office - the deep-research function that gathers the. |
...
- *Example request:* "Have the Code Editor take this on: Code Editor for the company's Project Architecture Office - the implementation arm that."
...
- *What it is for:* Research Agent for the company's Project Architecture Office - the deep-research function that gathers the.
