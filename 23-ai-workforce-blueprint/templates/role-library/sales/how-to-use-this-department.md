# How to Use the Sales Department 💰

**Department:** Sales
**Department head:** Director of Sales
**Folder:** `departments/sales/`
**Generated for:** {{COMPANY_NAME}}
**Last updated:** {{GENERATION_DATE}}

> This is the plain-language guide to the Sales department. Most
> people never realize this department exists or know how to put it to work.
> This document fixes that. When you ask "how do I use the Sales
> department?" or "how do I use the Account Executive Full Cycle?", this is the
...
In one sentence: **Turning interested people into paying customers**

You do not need to know which specialist does what. You just tell the department
what you want in plain English, and the department head (Director of Sales)
...
- For deals that don't split into SDR/Discovery/Closer, the AE owns the full deal cycle from qualified lead.
- Owns the relationship after the sale.
- Handles inbound leads who requested contact.
- Runs the proposal/close conversation.
- Bridges between Sales dept and CRM dept.
- Runs first sales conversation.
...
1. **Just say it in plain English.** Message your agent like you would a
   teammate: "I need help with something from the sales team." That is enough to start.
2. **Name the department if you want to be specific.** "Have the
   Sales department handle something from the sales team." This routes
   it straight to Director of Sales.
3. **Name a specialist if you know exactly who you want.** See the specialist
   list in Section 4 and ask for them by role: "Get the Account Executive Full Cycle
   to take on a sales task for you."
...
| --- | --- |
| **Account Executive Full Cycle** | For deals that don't split into SDR/Discovery/Closer, the AE owns the full deal cycle from qualified lead to closed-won. |
| **Account Manager Post Sale** | Owns the relationship after the sale. |
| **Appointment Setter** | Handles inbound leads who requested contact. |
| **Closer** | Runs the proposal/close conversation. |
| **CRM Specialist Sales Version** | Bridges between Sales dept and CRM dept. |
| **Discovery Call Specialist** | Runs first sales conversation. |
| **Follow Up Sequence Specialist** | Owns post-touchpoint sequences for prospects who didn't close immediately. |
...
- *What it is for:* For deals that don't split into SDR/Discovery/Closer, the AE owns the full deal cycle from qualified lead to closed-won.
- *Example request:* "Have the Account Executive Full Cycle take this on: For deals that don't split into SDR/Discovery/Closer."

**Account Manager Post Sale**

- *What it is for:* Owns the relationship after the sale.
- *Example request:* "Have the Account Manager Post Sale take this on: Owns the relationship after the sale."

**Appointment Setter**

- *What it is for:* Handles inbound leads who requested contact.
- *Example request:* "Have the Appointment Setter take this on: Handles inbound leads who requested contact."

**Closer**

- *What it is for:* Runs the proposal/close conversation.
- *Example request:* "Have the Closer take this on: Runs the proposal/close conversation."

**CRM Specialist Sales Version**

- *What it is for:* Bridges between Sales dept and CRM dept.
- *Example request:* "Have the CRM Specialist Sales Version take this on: Bridges between Sales dept and CRM dept."

**Discovery Call Specialist**

- *What it is for:* Runs first sales conversation.
- *Example request:* "Have the Discovery Call Specialist take this on: Runs first sales conversation."

**Follow Up Sequence Specialist**

- *What it is for:* Owns post-touchpoint sequences for prospects who didn't close immediately.
- *Example request:* "Have the Follow Up Sequence Specialist take this on: Owns post-touchpoint sequences for prospects who didn't close immediately."

**Proposal And Quote Specialist**

- *What it is for:* Professional voice that translates a sales conversation into a compelling, accurate, and closeable business document.
- *Example request:* "Have the Proposal And Quote Specialist take this on: Professional voice that translates a sales conversation into a compelling, accurate."

**Sales Operations Pipeline Specialist**

- *What it is for:* CRM hygiene, pipeline reporting, lead routing rules, sales tool stack maintenance.
- *Example request:* "Have the Sales Operations Pipeline Specialist take this on: CRM hygiene, pipeline reporting, lead routing rules, sales tool stack maintenance."
...
|---|---|
| "set up a booking bot" · "a conversational qualifier" · "an AI that books calls" · "a chat flow that qualifies leads" | Communication-driven funnel system |
| "look up a property" · "qualify a real estate lead" · "schedule a showing" | Real estate automation playbook |
...
1. **Acknowledgment.** Director of Sales confirms the request landed and, if
...
4. **Delivery.** You get the finished result: the finished sales work you asked for.
...
- "How do I use the Sales department?"
- "What can the Sales department do for me?"
- "How do I use the Account Executive Full Cycle?"
- "Who handles something from the sales team?"
- "What do I get back if I ask Sales for something from the sales team?"
