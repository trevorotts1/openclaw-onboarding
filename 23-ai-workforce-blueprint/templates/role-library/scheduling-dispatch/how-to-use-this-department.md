# How to Use the Scheduling & Dispatch Department 📅

**Department:** Scheduling & Dispatch
**Department head:** Director of Scheduling & Dispatch
**Folder:** `departments/scheduling-dispatch/`
**Generated for:** {{COMPANY_NAME}}
**Last updated:** {{GENERATION_DATE}}

> This is the plain-language guide to the Scheduling & Dispatch department. Most
> people never realize this department exists or know how to put it to work.
> This document fixes that. When you ask "how do I use the Scheduling & Dispatch
> department?" or "how do I use the Capacity Planning Specialist?", this is the
...
In one sentence: **Booking, routing, technician/staff scheduling**

You do not need to know which specialist does what. You just tell the department
what you want in plain English, and the department head (Director of Scheduling & Dispatch)
...
- Capacity Planning Specialist for the company's Scheduling & Dispatch department.
- Dispatcher for the company's Scheduling & Dispatch department.
- Scheduler for the company's Scheduling & Dispatch department.
...
1. **Just say it in plain English.** Message your agent like you would a
   teammate: "I need help with something from the scheduling & dispatch team." That is enough to start.
2. **Name the department if you want to be specific.** "Have the
   Scheduling & Dispatch department handle something from the scheduling & dispatch team." This routes
   it straight to Director of Scheduling & Dispatch.
3. **Name a specialist if you know exactly who you want.** See the specialist
   list in Section 4 and ask for them by role: "Get the Capacity Planning Specialist
   to take on a scheduling & dispatch task for you."
...
| --- | --- |
| **Capacity Planning Specialist** | Capacity Planning Specialist for the company's Scheduling & Dispatch department. |
| **Dispatcher** | Dispatcher for the company's Scheduling & Dispatch department. |
| **Scheduler** | Scheduler for the company's Scheduling & Dispatch department. |

### What each specialist is for, with an example request

**Capacity Planning Specialist**

- *What it is for:* Capacity Planning Specialist for the company's Scheduling & Dispatch department.
- *Example request:* "Have the Capacity Planning Specialist take this on: Capacity Planning Specialist for the company's Scheduling & Dispatch department."

**Dispatcher**

- *What it is for:* Dispatcher for the company's Scheduling & Dispatch department.
- *Example request:* "Have the Dispatcher take this on: Dispatcher for the company's Scheduling & Dispatch department."

**Scheduler**

- *What it is for:* Scheduler for the company's Scheduling & Dispatch department.
- *Example request:* "Have the Scheduler take this on: Scheduler for the company's Scheduling & Dispatch department."
...
1. **Acknowledgment.** Director of Scheduling & Dispatch confirms the request landed and, if
...
4. **Delivery.** You get the finished result: the finished scheduling & dispatch work you asked for.
...
- "How do I use the Scheduling & Dispatch department?"
- "What can the Scheduling & Dispatch department do for me?"
- "How do I use the Capacity Planning Specialist?"
- "Who handles something from the scheduling & dispatch team?"
- "What do I get back if I ask Scheduling & Dispatch for something from the scheduling & dispatch team?"
