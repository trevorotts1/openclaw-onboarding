...
| **gpt-image-2.5** (`gpt-image-2-5-sunburst-text-to-image`, `gpt-image-2-5-sunburst-image-to-image`) | Source/keyframe image generation for image-to-video; brand-locked frames via I2I; 2K with explicit aspect ratio | `POST /api/v1/jobs/createTask` (docs.kie.ai/market/gpt/gpt-image-2-5-sunburst-image-to-image) | — |
...
3. **Narrated footage** — **ElevenLabs voice** (Kie-first) over generated footage (Veo 3.1 / Runway / Seedance / Happy Horse) or Ken-Burns motion on gpt-image-2.5 stills.
...
**Tools (all via Kie.ai):** gpt-image-2.5 (source images) → Veo 3.1 `veo3_fast` image-to-video → ffmpeg finish
**Process:**
1. Generated 8 source images with **gpt-image-2.5 via Kie** (2K, explicit 16:9 aspect ratio) — variations of desk setup, lighting, and composition.
...
- **Kie model quickstarts** — Veo 3.1 (docs.kie.ai/veo3-api), Runway (docs.kie.ai/runway-api), Seedance (docs.kie.ai/market/bytedance), Gemini Omni (docs.kie.ai/market/gemini-omni-video), Grok Imagine (kie.ai/grok-imagine), avatars (kie.ai/omnihuman-1-5), gpt-image-2.5 (docs.kie.ai/market/gpt), Suno (docs.kie.ai/suno-api), ElevenLabs TTS (kie.ai/elevenlabs-tts)
