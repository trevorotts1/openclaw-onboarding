...
>
> The agent must emit the disclosure header `[GHL tier used: N — tool_name]` on every GHL-data response per skill 36's protocol. If neither skill 44 nor skill 36 is installed, this skill falls back to the direct API workflow below.
