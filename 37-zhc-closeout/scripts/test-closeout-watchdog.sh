...
# ZHC_SKIP_PROVIDER_SMOKE=1 prevents B7 provider-capability smoke from running in the
# hermetic test environment where openclaw.json / live API keys are not present.
run_script() {
  HOME="$FAKE_HOME" \
