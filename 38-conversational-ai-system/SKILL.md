...
<!-- SELF-COUNTS: re-verify on EVERY version bump — see scripts/bump-version.sh "Skill 38 self-count
     re-verification" note. Counts as of v1.5.0: protocols/=38 (*.md — v1.5.0 added the 6 Round-3 Queue-A
     CORE protocols: aggression-detection, smart-playbook-switching (F44 detour-and-return),
     geo-qualification, crm-field-write, smart-faq, zhc-tag-prefix), scripts/=42 (*.sh — v1.5.0 added
     qc-zhc-tag-prefix.sh), references/=16 (*.md), journey templates=8 dirs (unchanged since v1.4.15).
     NEXT-PATCH wave (skill38-three-qc-standards) adds 3 standard gates (qc-communications-playbook-standard.sh,
     qc-ghl-raw-body-standard.sh, qc-notion-doc-standard.sh) → scripts/=45, and 2 NEW reference standards
     (ghl-raw-body-json-standard.md, notion-client-doc-standard.md; communications-playbook-standard.md ELEVATED
     in place, not added) → references/=17 (count was 15 in prose / 16 file-count pre-wave).
     Run: ls -1 protocols/*.md scripts/*.sh references/*.md | per-dir wc -l. -->
- 38 protocol files under `protocols/` (humanizer is intentionally NOT here — skill 19 owns it)
