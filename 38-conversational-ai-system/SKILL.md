...
<!-- SELF-COUNTS: re-verify on EVERY version bump — see scripts/bump-version.sh "Skill 38 self-count
     ...
     for F49: 26-verify-pixel-prerequisites, 27-render-pixel-js, 28-configure-pixel-hook,
     29-deploy-pixel-cloudflare, qc-zhc-pixel, qc-zhc-pixel.test; the v1.5.1 standards wave added 3
