...
<!-- SELF-COUNTS: re-verify on EVERY version bump — see scripts/bump-version.sh "Skill 38 self-count
     re-verification" note. Counts as of v1.5.2 (F49 ZHC Pixel, rebased onto the v1.5.1 three-QC-standards
     wave): protocols/=39 (*.md — v1.5.2 added zhc-pixel-protocol.md for F49; v1.5.0 added the 6 Round-3
     Queue-A CORE protocols: aggression-detection, smart-playbook-switching (F44 detour-and-return),
     geo-qualification, crm-field-write, smart-faq, zhc-tag-prefix), scripts/=51 (*.sh — v1.5.2 added 6
     for F49: 25-verify-pixel-prerequisites, 26-render-pixel-js, 27-configure-pixel-hook,
     28-deploy-pixel-cloudflare, qc-zhc-pixel, qc-zhc-pixel.test; the v1.5.1 standards wave added 3
     standard gates: qc-communications-playbook-standard, qc-ghl-raw-body-standard, qc-notion-doc-standard;
