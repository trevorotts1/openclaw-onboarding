...
echo "[skill 38] MEMORY.md updated (rules 6-14 + builder design rules 15-19 + round-3 queue-A rules 20-25 + round-2 backlog rules 26-29 appended; backup at $MEM_MD.bak-*)"
