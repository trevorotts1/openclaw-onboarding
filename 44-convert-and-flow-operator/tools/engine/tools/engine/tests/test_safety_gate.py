...
Run with:
    python -m pytest tools/engine/tests/test_safety_gate.py -v

Or standalone:
    python tools/engine/tests/test_safety_gate.py
...
# Ensure the engine root (3 levels up from this file) is on sys.path
