# VENDOR BUILD BRIEF — Design Intelligence Unit (SUPERSEDED)
**Original Author:** Vendor | **Timestamp:** 2026-06-12 | **Status:** Provenance document (superseded by Skill 45 + role-library/graphics roles)

This document is preserved for reference. Implementation details have been absorbed into:
- **Skill 45** () — library system files, category rules, protocols
- **Role Library** () — five specialist roles, operating rules, SOPs
- **00-START-HERE.md** (graphics dept) — unit definition, intake routing, SOP mirrors
...
| SOP-DIU-202 Deck Generation & Rotation Engine | Deck Systems Specialist | PPT-ANALYSIS-SOP §§3B–3C, powerpoint _RULES |
