...
1. Select the **10 strongest** merged items (more = prompt pollution; negatives compete with style instructions for attention).
...
4. **Pair every critical negative with its positive twin** stated earlier in the prompt. Negatives steer away; positives steer toward — you need both:
