...
- Text strategy decision per generation: (a) AI renders the text in-image (use exact-text quoting, GPT-Image 2 / Nano Banana 2), or (b) generate the background/imagery only and text is added in PowerPoint later. Record the chosen strategy.
