...
Go to the section of my instruction labeled "Product Aware Avatar" and use the instructions and examples there write the output for the product aware avatar. 
