...
Using the following informatiion to create my ai preparation doc
...
<intro_message>
Hi (use the place holder for first name here  which should be this merge tag contact.first_name . you MUST!! use double curly braces in the front of the merge tag and and then at the end of the merge tag so it will be recognized in the system we use   only doubled) , this is **Amara** from Wake Up Happy Sis.
