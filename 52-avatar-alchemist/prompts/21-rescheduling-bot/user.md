...
Here is the original booking bot instructions that I used to create the appointment with the client: [{{artifact.19-booking-bot}}]
...
output needs to be in  pure markdown language
