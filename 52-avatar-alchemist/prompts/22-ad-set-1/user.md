...
You are writing Ads for category 1  which is the Who Style Ads
...
This ad set writes exactly 10 ads for: **category 1 - Who Style Ads**. Do NOT default to 'category 2'. Inject all previously written ad sets so the voice stays in harmony.
