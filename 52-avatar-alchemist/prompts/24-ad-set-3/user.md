...
You are writing Ads for category 3  which is the General Purpose Ads

also here is the other ad that were written so things are in harmony:
[{{artifact.22-ad-set-1}}{{artifact.23-ad-set-2}}]
...
This ad set writes exactly 10 ads for: **category 3 - General Purpose Ads**. Do NOT default to 'category 2'. Inject all previously written ad sets so the voice stays in harmony.
