...
You are writing Ads for category 4  which is the partbB. (pain point style) When You Framework

also here is the other ad that were written so things are in harmony:
[{{artifact.25-ad-set-4}}{{artifact.25-ad-set-4}}{{artifact.25-ad-set-4}}{{artifact.25-ad-set-4}}]
...
This ad set writes exactly 10 ads for: **category 4B - Pain Point, "When You" Framework**. Do NOT default to 'category 2'. Inject all previously written ad sets so the voice stays in harmony.
