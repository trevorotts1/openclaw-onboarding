...
This ad set writes exactly 10 ads for: **category 4C - Pain Point, "If You Have Never" Framework**. Do NOT default to 'category 2'. Inject all previously written ad sets so the voice stays in harmony.
