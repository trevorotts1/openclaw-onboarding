...
# Avatar Intelligence — Brand Intelligence Engine (Skill 52)
...
3. **Content gate** — `aa_build_check.py` enforces stripped-word floors, exact counts (39
   ...
   image-prompt band, the 13 restored ad-set categories, bot-doc structure, the 12-section
