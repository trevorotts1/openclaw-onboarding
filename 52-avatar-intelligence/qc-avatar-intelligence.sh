#!/usr/bin/env bash
# qc-avatar-intelligence.sh — CI gate for Skill 52. Manifest↔prompts lockstep (40/40),
...
if [ "$fail" = 0 ]; then echo; echo "QC-AVATAR-INTELLIGENCE: ALL GREEN"; else echo; echo "QC-AVATAR-INTELLIGENCE: FAILURES ABOVE"; fi
exit "$fail"
