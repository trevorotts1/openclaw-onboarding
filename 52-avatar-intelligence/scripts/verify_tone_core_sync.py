...
Compares 52-avatar-intelligence/prompts/{04..08} against
shared-utils/tone-writing-core/prompts/{04..08}. Fail-closed.
...
def main() -> int:
    ...
    if drift:
        print(f"FAIL: {len(drift)} tone-core drift(s) — skill baked copy != canonical shared core.")
        for d in drift:
            print(f"  DRIFT {d}")
        return 2
