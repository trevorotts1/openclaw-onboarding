#!/usr/bin/env python3
# =============================================================================
# SKILL 59 — ANTHOLOGY ENGINE :: u05_modules/house_rules.py  (U05 tooling)
...
# u05_modules.house_rules, per the u05_modules package contract in __init__.py
...
# the U05 live verifier and its check modules import, so a law can NEVER drift
...
# other u05_modules: sys.path.insert to scripts/ then
