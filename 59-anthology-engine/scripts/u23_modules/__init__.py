#!/usr/bin/env python3
# =============================================================================
# SKILL 59 — ANTHOLOGY ENGINE :: u23_modules package init
# FAIL-CLOSED EMPTY PACKAGE INIT. This file deliberately contains NO runtime
# code: the u23_modules package is a pure namespace container whose modules
# are imported by NAME (import u23_modules.<module>) from the engine scripts.
# -----------------------------------------------------------------------------
...
#   - Provisioning fails closed: any provision ACTION in this package
#     (create / provision / enable / subscribe / deploy) requires the caller
#     to pass --execute explicitly (Trevor-gated). Without --execute the
#     module must report what it WOULD do and exit without mutating.
#   - Move in silence: operator-verbose only; nothing Anthropic in any runtime
#     file.
# =============================================================================
"""u23_modules -- empty, fail-closed package namespace for the engine's modules."""
