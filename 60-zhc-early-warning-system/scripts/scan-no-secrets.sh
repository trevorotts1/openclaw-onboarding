#!/usr/bin/env bash
# 60-zhc-early-warning-system/scripts/scan-no-secrets.sh
# ----------------------------------------------------------------------------
# MERGE-GATE STATIC SCAN #1 of 4 for Skill 60 (ZHC Early Warning System),
...
# present anywhere in the scanned tree -- the static enforcement of Skill 60
...
#
# EXIT CODES (Skill 60 merge-gate house convention, mirrored from Skill 59's
