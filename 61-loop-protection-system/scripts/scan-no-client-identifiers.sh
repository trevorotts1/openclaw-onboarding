#!/usr/bin/env bash
# 61-loop-protection-system/scripts/scan-no-client-identifiers.sh
# ----------------------------------------------------------------------------
# MERGE-GATE STATIC SCAN #3 of 4 for Loop Protection System (Skill 61),
...
# the scanned tree -- enforces Skill 61 doctrine point 5, "NEVER commingle
