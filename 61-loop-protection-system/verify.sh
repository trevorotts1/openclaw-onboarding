...
step "3/3 fixture drills (D-RESTART, D-SIG, D-RESEND, D-OFFSET, D-ORPHAN, D-BURN, D-BACKOFF, D-HEALERLOOP, D-ESCALATE, D-DRYRUN, D-ARMED-PARK, D-REVERT, D-COLLECT, D-COLLECT-DELTA, D-COLLECT-FALLBACK)"
...
# P1 (LP-A8, the 2026-08-04 sessions_send-timeout-misread incident); a 2-send
...
p1_units = {x["unit"] for x in f7 if x["severity"] == "P1" and x["loop_class"] == "LP-A8"}
