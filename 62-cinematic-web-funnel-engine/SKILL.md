...
> The full binding contract lives in `MASTERDOC.md` and the source specification at
> `/Users/blackceomacmini/Downloads/cinematic-web-funnel-engine-docs/CINEMATIC-AND-WEB-FUNNEL-ENGINE-SPEC.md`.
