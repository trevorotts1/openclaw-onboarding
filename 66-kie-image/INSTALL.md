...
══════════════════════════════════════════════════════════════════
KIE IMAGE (SKILL 66) - INSTALLATION GUIDE
══════════════════════════════════════════════════════════════════
...
TEST 3: Confirm the three validators + selector pass deterministically:
  ...
  python3 scripts/select_image_model.py --self-test
...
`<!-- BEGIN/END skill:66-kie-image:<target> -->` marker REPLACE-IN-PLACE, with
the master-files path resolved to an absolute path on this box, and stamps
`<!-- skill:66-kie-image:core-update-applied -->`. Earlier versions of other
