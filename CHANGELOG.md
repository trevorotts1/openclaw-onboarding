## [v16.7.0]  -  2026-07-02  -  feat(skill-52): Avatar Intelligence — the Avatar Alchemist brand-intelligence engine (ONE completed brand-intake interview → 40 generators across 7 subsystems → 16 named deliverables / 37 documents) shipped as a governed, fail-closed skill that replaces the retired 233-node n8n / Airtable / Google Drive / Slack / Gmail workflow with a LOCAL-ONLY pipeline on the CLIENT's own model providers, gated by model-free provers that MEASURE the stripped text (self-reported counts ignored); also lands the SHARED tone/writing core module referenced by the writing family (52/53/54)
...
### New skill: 52-avatar-intelligence (Avatar Intelligence — Brand Intelligence Engine)
...
- `README.md` — skill-count prose (×2): 52 → 53 folders, 47 → 48 active; new `52-avatar-intelligence` inventory-table row
