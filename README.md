...
> **Version:** see `/version` - this repo at v12.3.7.
...
**Current Version: v12.3.7** — See [CHANGELOG.md](CHANGELOG.md) for the full per-release history.
