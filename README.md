...
> **Version:** see `/version` - this repo at v12.39.0.
>
...
**Current Version: v12.39.0** - See [CHANGELOG.md](CHANGELOG.md) for the full per-release history.
