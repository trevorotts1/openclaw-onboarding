...
**Current Version: v13.8.19** - See [CHANGELOG.md](CHANGELOG.md) for the full per-release history.
...
This repo contains **47 numbered skill folders (01 through 47)** — 42 active plus 5 archived (11, 13, 21, 33, 34) — plus an install script and update script. See the [Skill Inventory](#skill-inventory-folder-names) below for the full live list.
