...
> **Version:** see `/version` - this repo at v12.3.6.
...
**Current Version: v12.3.6** — See [CHANGELOG.md](CHANGELOG.md) for the full per-release history.
