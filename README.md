...
> **Version:** see `/version` - this repo at v10.15.33.
...
>
> **NOTE (v10.15.33) — fleet standards: sub-agent permissions + 50MB media cap + version-marker reconciliation.** Ships `apply-fleet-standards.sh` (sub-agents fully permitted + Telegram media cap 50 MB) wired into install/update; reconciles all 9 version markers to v10.15.33 (update-skills.sh had already advanced to this marker on client machines). Per-release version history lives in [CHANGELOG.md](CHANGELOG.md). VPS (10.16.x) and Mac (10.15.x) sequences remain intentionally independent.
>
...
**Current Version: v10.15.33** — See [CHANGELOG.md](CHANGELOG.md) for the full per-release history.
