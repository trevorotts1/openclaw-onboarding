...
| U91 | [X/U-X1] (doc, P0) Banned-term scrub of the spec text (12 v1 hit-lines superseded) — **executed in this document**; run verifies first |  | pending |  |  |
...
**Total: 117 units (U1-U117), all `pending`. Labels/evidence blank pending dispatch.**
