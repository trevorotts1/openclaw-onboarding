...
| S7 cover | Pinned cover prompt, Kie.ai GPT-Image-2.5 PORTRAIT 1024x1536 via the W0.6-verified text-to-image endpoint (never the 16:9 presentation recipe), callback completion, PNG in Drive, no hardcoded key | Static key scan, callback relay log |
