...
#
#   T1. ARMED: a full 30-dept board -> exit 0, floor_short=false, overall_armed=true.
...
FULL_30="marketing sales billing-finance customer-support web-development app-development graphics funnels video audio research communications crm openclaw-maintenance legal social-media paid-advertisement personal-assistant general-task project-architecture-office bugs healer quality-control master-orchestrator presentations scheduling-dispatch logistics-fulfillment engineering account-management podcast"
...
echo "=== T1: ARMED -- full 30-dept board ==="
DD1="$(mk_ws t1 $FULL_30)"
