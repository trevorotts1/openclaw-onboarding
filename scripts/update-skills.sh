...
## 🔴 UPDATE PENDING — Read /tmp/oc-update/openclaw-onboarding-main/UPDATE-PLAYBOOK.md and follow it step by step. Report back when done. Remove this flag when complete.
UPDATEFLAG
    fi
fi
...
echo ""
echo '    "There is an update staged in /tmp/oc-update. Read /tmp/oc-update/openclaw-onboarding-main/UPDATE-PLAYBOOK.md and follow it step by step. Report back when done."'
echo ""
