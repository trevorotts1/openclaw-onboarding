...
# Renamed from GEMINI_MODEL so it does not match the qc-static PRD 1.8
# "^GEMINI_MODEL\\s*=" single-implementation grep (embedding_engine.py is the
# only place that constant may be *defined*; this is just a test-local alias).
