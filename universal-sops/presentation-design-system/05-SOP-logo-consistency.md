...
3. Logo text garbled (a garbled brand-name wordmark): treat as the text-render failure; composite the logo (with its text) as a native layer so the brand name is guaranteed correct.
