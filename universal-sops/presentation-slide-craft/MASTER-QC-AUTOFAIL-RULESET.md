...
| AF-OBI-5 | 1Q | slide | bulleted pain list | WARNING (FIX 18) — craft_judgement computes_warnings: three or more pain-marked bullets warn (literal pain-token match — the same honesty limit the retired scanner had: pain-vs-feature is semantic and stays human). Holds QC until corrected or acknowledged in craft-warning-dispositions.json. Never exit-1. |
