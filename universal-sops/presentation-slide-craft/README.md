# Presentation Slide Craft SOP Cluster (`universal-sops/presentation-slide-craft/`)
...
This craft cluster (`universal-sops/presentation-slide-craft/`) is the execution playbook for the skill(s) below. A specialist reaches for it when the client's plain-language request matches any of these intents — the client never has to name the skill or type its slash command. Source of truth: `23-ai-workforce-blueprint/skill-department-map.json` (Layer D).

| Skill | Reach for this craft when the client says… |
|---|---|
| **51** signature-presentation | "a signature talk" · "a keynote deck" · "a 100-slide presentation" · "build my signature presentation" |
