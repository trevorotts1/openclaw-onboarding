...
| HOOK-7: Signature quote conflated with the hook | The dedicated signature-quote slide also carries the main contrast-style hook. | "AF-HOOK (HOOK-7): slide N is the signature-quote beat but also carries the main hook. Keep them as two separate beats. Remove the main hook from the quote slide." |
