...
**Status:** BINDING. Defines the single attestation artifact the renderer auto-fails (AF-RENDERER / AF-MODEL-SOVEREIGNTY / AF-CONVERTER-PARITY) and AF-COVERAGE-1 assert against. (Flipped from DRAFT 2026-09-02 per MASTER-ASSESSMENT Fix 96: the codes above are REGISTERED in `SOP-MECHANICAL-ENFORCEMENT-REGISTRY.md` and `scripts/build_deck.py` reads the manifest, so the SOP is enforced, not pending.)
...
1. Confirms every phase this run actually dispatched has an entry with `ran: true` — every `phases[].id` in `PIPELINE-MANIFEST.json` MINUS any that correctly DEFERRED per its own preflight (`P-CONVERTER` off the content-first path; `P-SP-INTAKE` / `P-SP-INTAKE-TRACE` / `P-SP-STRUCTURE` / `P-SP-P3-HYGIENE` on a non-signature deck; `P-SPEECH-QC` when no speech was produced; `P-U-SALES-BUILD` / `P-U-CHECKOUT-BUILD` / `P-U-FORM-CHECKOUT` when the client declines the sales/checkout upsell; `P-U-VSL-BUILD` when the client declines the VSL upsell; `P-STYLE-PICK` and `P-STYLE-SPEC` defer when the style-preview band is out of the run's `DELIVERABLE_SET`; `P8.3-INFOGRAPHIC` defers when the intake's deliverable bundle excludes the one-page infographic checklist; `P-BUNDLE-GATE` NEVER defers — it is the terminal bundle-completeness gate on every run). The current full registry (manifest_version 61, 62 phases, in `order`): `P-CONVERTER`, `P-0.5-RESEARCH`, `P0A-INTAKE`, `P-SP-CLAIM`, `P-SP-INTAKE`, `P-SP-INTAKE-TRACE`, `P0B-PRIORITY`, `P3-ARC`, `P-3.5-RESEARCH-MAP`, `P-U-SALES-COPY`, `P-U-CHECKOUT-COPY`, `P-U-VSL-RESEARCH`, `P-U-VSL-COPY`, `P4-COPY`, `P-SP-STRUCTURE`, `P-SP-P3-HYGIENE`, `P-U-DESIGN-SALES`, `P-U-DESIGN-RENDER-SALES`, `P1Q-COPY-QC`, `P-U-DESIGN-CHECKOUT`, `P-U-DESIGN-RENDER-CHECKOUT`, `P-U-DESIGN-VSL`, `P-U-DESIGN-RENDER-VSL`, `PF-DESIGN`, `P-TYPO-QC`, `P4-PROMPT`, `P-PROMPT-QC`, `P-STYLE-PREVIEW`, `P-STYLE-SPEC`, `P-STYLE-PICK`, `P4-RENDER`, `P-IMAGE-QC`, `P-U-HTML-SALES`, `P-U-HTML-CHECKOUT`, `P-U-HTML-VSL`, `P-U-FORM-GATE`, `P-U-GHL-SALES`, `P-U-GHL-VSL`, `P-SHIFT-QC`, `P8-ASSEMBLE`, `P8.1-PDF-EXPORT`, `P8.2-GUIDE`, `P8.25-WORKBOOK`, `P8.3-INFOGRAPHIC`, `P9-SPEECH`, `P8.4-FISH-TAG`, `P9-SPEECH-WEBINAR-INTRO`, `P9.1-SPEECH-PDF`, `P-SPEECH-QC`, `P-QC-AGGREGATE`, `P9.5-NOTES-SYNC`, `P-U-SALES-BUILD`, `P-U-CHECKOUT-BUILD`, `P-U-FORM-CHECKOUT`, `P-U-COLLATERAL`, `P9.2-GHL-UPLOAD`, `P9.6-WEBINAR-VIDEO`, `P-U-VSL-BUILD`, `P7-TELEPROMPTER`, `P9-DELIVER`, `P-U-QC`, `P-BUNDLE-GATE`. Kept in lockstep with the manifest by GATE 4 of `scripts/ci/presentations-drift-gates.sh` (fails CI if this list and the manifest diverge).
