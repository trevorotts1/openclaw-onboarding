...
This craft cluster (`universal-sops/sales-page-craft/`) is the execution playbook for the skill(s) below. A specialist reaches for it when the client's plain-language request matches any of these intents — the client never has to name the skill or type its slash command. Source of truth: `23-ai-workforce-blueprint/skill-department-map.json` (Layer D).

| Skill | Reach for this craft when the client says… |
|---|---|
| **56** sales-page-assets | "a sales page" · "upsell and downsell copy" · "a high-ticket page" · "write my sales page" |
